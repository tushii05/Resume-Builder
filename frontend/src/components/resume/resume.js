        ...
        <Container className="mt-4 mb-2">
          <main className="resume-section pl-4">
            ...
            <Row>
              <Col className="py-4">
                <ul>
                  <h1 className="w-100"> Hobbies </h1>
                  <h4>{userResumeData.userHobbies}</h4>
                  {/* <p>{userResumeData.userHobbiesDescribe}</p> */}
                  <p className="text-dark font-weight-normal">
                    {userResumeData.userHobbiesDescribe}
                  </p>
                </ul>
              </Col>
            </Row>
            ...
            <Row>
              <Col className="py-4">
                <ul>
                  <h1 className="w-100"> Strength </h1>
                  <h4>{userResumeData.userStrength}</h4>
                  {/* <p>{userResumeData.userStrengthDescribe}</p> */}
                  <p className="text-dark font-weight-normal">
                    {userResumeData.userStrengthDescribe}
                  </p>
                </ul>
              </Col>
            </Row>
            <Row>
              <Col className="py-4">
                <ul>
                  <h1 className="w-100"> Weakness </h1>
                  <h4>{userResumeData.userWeakness}</h4>
                  {/* <p>{userResumeData.userWeaknessDescribe}</p> */}
                  <p className="text-dark font-weight-normal">
                    {userResumeData.userWeaknessDescribe}
                  </p>
                </ul>
              </Col>
            </Row>
